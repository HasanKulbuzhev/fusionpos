...
class SiteController extends Controller
{
    ...
    public function actionIndex()
    {
        $dataProvider = new ArrayDataProvider([
            'allModels' => $this->service->getItems(Product::$api_params),
            'pagination' => [
                'pageSize' => 10,
            ],
        ]);
        $categories = $this->service->getItems(Category::$api_params);
    ...
    {
        $product = $this->service->getItem(Product::$api_params, $id);
